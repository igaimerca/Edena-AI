  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative">
      ...
      <div className="text-left p-6 mt-4">
        <h1 className="text-white text-2xl font-bold mb-2">Insider Edge</h1>
        <p className="text-white/70 text-lg">
          See who works at the company and connect for referrals, tips, and interview advice.
        </p>
      </div>
    </div>
  );
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full max-w-7xl min-h-[800px] md:min-h-[800px] md:h-[800px]">
        <CardWithEffect>
          <div className="flex flex-col justify-between h-full">
            ...
            <div className="text-left p-6 mt-4">
              <h1 className="text-white text-2xl font-bold mb-2">One-click Auto-Apply</h1>
              <p className="text-white/70 text-lg">
                Automatically fill out job applications and generate tailored answers + cover letters using your resume and the job description.
              </p>
            </div>
          </div>
        </CardWithEffect>
          ...
          <CardWithEffect>
            <div className="flex flex-col justify-center h-full">
              ...
              <div className="text-left p-6">
                <h1 className="text-white text-2xl font-bold mb-2">Smart Tracker</h1>
                <p className="text-white/70 text-lg">
                  Track where you've applied, what you said, and what's next. Stay on top of every opportunity.
                </p>
              </div>
            </div>
          </CardWithEffect>
