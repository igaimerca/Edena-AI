      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8 ">
          <div className="inline-flex relative">
            <h1 className='text-7xl sm:text-8xl font-bold tracking-tightner text-center inline-flex'>Edena - AI that talks to you like a real recruiter.</h1>
        ...
        <div className="flex justify-center">
          <p className='text-xl text-center mt-8 max-w-md'>A personalized interview coach that helps you get hired faster — with AI that talks to you like a real recruiter.</p>
        </div>
        <div className="flex justify-center mt-8">
          <button className='bg-white text-black py-3 px-5 rounded-lg font-medium'>Get Started for Free</button>
        </div>
